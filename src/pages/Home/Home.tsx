        ...
        <div className="wrapper" style={{ flex: ".6" }}>
          <Slide left>
            <img
              ...
              src="https://cdn.discordapp.com/attachments/762721371809382421/790588651981373470/skooly-5.png"
            />
          </Slide>
        </div>
        <div
            ...
            <div>
              ...
              <div style={{ fontFamily: "Georgia", paddingTop: "2rem" }}>
                <p style={{ textAlign: "left" }}>
                  Besides from, AlphaPlus is a completely free online school
                  management software it has more school management features
                  than any other online school management system in the market.
                  It does not ends here, AlphaPlus <br />
                  is still enhancing features. You will be automatically updated
                  as new feature will be a part of our free school management
                  software. Some main school management features are given
                  below.
                </p>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <div style={{ display: "flex" }}>
                    <Slide right>
                      ...
                      />{" "}
                      <h5>An admin portal with all controls</h5>
                    </Slide>
                  </div>
                  <div style={{ display: "flex", paddingBottom: ".5rem" }}>
                    <Slide right>
                      ...
                      />{" "}
                      <h5>Portals for students/parents, staff and teachers.</h5>
                    </Slide>
                  </div>
                  <div style={{ display: "flex", paddingBottom: ".5rem" }}>
                    <Slide right>
                      ...
                      />{" "}
                      <h5>Students and staff complete data record system.</h5>
                    </Slide>
                  </div>
                  <div style={{ display: "flex", paddingBottom: ".5rem" }}>
                    <Slide right>
                      ...
                      />{" "}
                      <h5>Classes, Courses and Subjects management.</h5>
                    </Slide>
                  </div>
                  <div style={{ display: "flex", paddingBottom: ".5rem" }}>
                    <Slide right>
                      ...
                      />{" "}
                      <h5>
                        Exams, class tests, home work and assignments
                        management.
                      </h5>
                    </Slide>
                  </div>
          ...
          <div style={{ flex: ".65" }}>
            ...
            <div style={{ paddingLeft: "12rem" }}>
              <p style={{ textAlign: "left", padding: ".5rem" }}>
                ...
                staff,timetable,exams, class test, attendance, fees collection,
                accounts. <br />
                It does not ends here. Parents are always worried about their
                child performance <br />
                and they need satisfaction. They really care about their child
                academic statics. <br />
                Moreover we have seen schools using huge registers to mark
                attendance of their <br />
                students and staff. And we have also seen that schools manage
                their admission, <br />
                exams data, class tests data ect, manually. We know it takes a
                lot of time and very difficlt to manage. Well ! it's time to put
                check on these worries. AlphaPlus presents you a free online
                school management software to make conventional tasks easier.
                This is one stop solution to manage, track and record everything
                within your school or organization. Our free online school
                management software includes admin, staff and students panel,
                exams madule, attendance madule, fees collection madule, salary
                and expense management, class tests management, inventory
                management, students and staff data record system and many more.
                It is very easy to use and manage because AlphaPlus is a free
                online school management software for end-users. If you can send
                an email you can use AlphaPlus.
              </p>
            </div>
          </div>
        </Slide>
        <div style={{ flex: ".4" }}>
          <Roll right>
            <img
              ...
              height="450px"
              src="https://media.discordapp.net/attachments/762721371809382421/791006742947037194/signin_native.png?width=229&height=473"
            />
          </Roll>
        </div>
      </div>
        ...
        >
          <div style={{ flex: ".5", paddingTop: "2rem" }}>
            <img
              ...
              src="https://www.alphaplus.co.uk/wp-content/uploads/2018/04/alphaplus_white_logo.png"
            />
            <h5 style={{ paddingLeft: "8rem" }}>
              {" "}
              © 2020 AlphaPlus Consultancy Ltd, all rights reserved.
            </h5>
            <p style={{ textAlign: "left", marginLeft: "12.5rem" }}>
              AlphaPlus is world's best and no.1 free online school management
              softawre for lifetime with no limitations. Someone can manage
              their school, college, tuition center, academy or any kind of
              educational institute with AlphaPlus.Our school management
              software has more features than any school software in the market.
            </p>
          </div>
          <div style={{ flex: ".4" }}>
