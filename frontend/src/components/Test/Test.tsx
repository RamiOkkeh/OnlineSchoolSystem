...
//   function Question(dataSet:any, handleClick:any) {
//     var style = {
//       color: "red",
//     }
//     return (
//       <h1 style={style}>{dataSet.question}</h1>
//     )
//   }
  
//   function Answer(dataSet:any, handleClick:any) {
//     var style = {
//       width: "100%",
//       height: 50,
//       color: "blue"
...
//     return(
//       <div>
//         <button style={style} onClick={() =>handleClick(choice)}>{answer}</button>
//       </div>
//     )
//   }
