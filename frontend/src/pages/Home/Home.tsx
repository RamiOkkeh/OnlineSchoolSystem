  ...
  return (
    <div>
      <Slider {...settings} style={{ marginTop: "2.8rem", marginLeft: "9rem" }}>
        <div >
          <h3>
            <img src="https://d21zeai4l2a92w.cloudfront.net/wp-content/uploads/2017/05/teacher-appreciation-kindergarten.jpg" style={{ maxHeight: '550px', width: "100%" }} />
          </h3>
        </div>
        <div >
          <h3>
            <img src="http://www.chuquxueba.com/wp-content/uploads/2020/01/trinity-grammar-school-027.jpg" style={{ maxHeight: '550px', width: "100%" }} />
          </h3>
        </div>
        <div >
          <h3>
            <img src="https://www.trinity.nsw.edu.au/wp-content/uploads/2015/08/banner_home011.jpg" style={{ maxHeight: '550px', width: "100%" }} />
          </h3>
        </div>
        <div>
          <h3>
            <img className="bodyImage" src="https://3.files.edl.io/ed5f/19/03/30/052542-6859498f-d8c6-4b3a-8c67-8b086629ceef.jpg" style={{ maxHeight: '550px', width: "100%"}} />
          </h3>
        </div>
        <div >
          <h3>
            <img src="https://www.nelsonstar.com/wp-content/uploads/2019/06/17343520_web1_teacher.jpg" style={{ maxHeight: '550px', width: "100%" }} />
          </h3>
        </div>
        <div>
          <h3>
            <img className="bodyImage" src="https://www.ousd.org/cms/lib/CA01001176/Centricity/ModuleInstance/22885/large/Students%20at%20desk20.jpeg" style={{ maxHeight: '550px', width: "100%" }} />
          </h3>
        </div>
        <div>
          <h3>
            <img className="bodyImage" src="https://www.trinity.nsw.edu.au/wp-content/uploads/2015/08/banner_home02.jpg" style={{ maxHeight: '550px', width: "100%"}} />
          </h3>
        </div>
        <div>
          <h3>
            <img className="bodyImage" src="https://3.files.edl.io/398f/19/03/30/052431-03cfe924-a73a-4108-a9ae-c234d5e8d190.jpg" style={{ maxHeight: '550px', width: "100%" }} />

          </h3>
        </div>
        <div>
          <h3>
            <img className="bodyImage" src="https://3.files.edl.io/789e/19/03/30/052658-5f62156a-d55c-437b-8cd4-612d7b510db0.jpg" style={{ maxHeight: '650px', width: "100%" }} />
          </h3>
        </div>
      </Slider>
